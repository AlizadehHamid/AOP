...
public class AppLogging {
    ...
    @Before(value = "execution(* com.example.aop.service.EmployeeService.*(..)) && args(employee)")
    ...
    @After(value = "execution(* com.example.aop.service.EmployeeService.*(..)) && args(employee) ")
    ...
    //    @Around("logApp()")
    @Around("execution(public * com.example.aop.service.*.*(..)) && @annotation(com.example.aop.aop.Log)")
